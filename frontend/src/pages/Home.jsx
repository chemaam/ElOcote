  ...
  return (
    <div ref={sectionRef} className="min-h-screen">
      ...
      <section className="py-20 sm:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 text-center scroll-hidden">
          <div className="flex justify-center gap-1 mb-5">
            {[...Array(5)].map((_, i) => (
              <svg key={i} className="w-8 h-8 text-amber-400 fill-amber-400" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
            ))}
          </div>
          <h2 className="text-2xl sm:text-3xl font-heading font-bold text-wood-900 mb-3">
            ¿Ya trabajaste con nosotros?
          </h2>
          <p className="text-wood-600 text-lg mb-8 max-w-xl mx-auto">
            Tu opinión nos ayuda a crecer y a que otros clientes nos encuentren en Google. Solo toma un minuto.
          </p>
          <a
            href={businessInfo.reviewUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-wood-900 hover:bg-wood-800 text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-wood-900/20 hover:-translate-y-0.5"
          >
          ...
          <p className="text-wood-400 text-sm mt-4">Se abre Google Maps en una nueva pestaña</p>
        </div>
      </section>
